...
const Card: React.FC<CardProps> = ({ title, content, linkUrl, className }) => {
  return (
    ...
    >
      <div className="absolute -inset-1 bg-gradient-to-l from-red-600 to-violet-600 rounded-lg blur opacity-25 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
